/*  Purpose of this class is to provide the functionality of a faculty to modify student grade. It takes the student, course code,grade and reason
 as parameters and sets the grade if the student is registered in the course. Otherwise, it warns the faculty.
 It also implements Composite design pattern. A faculty can modify grade to a single student or a group of students by calling the same execute method. So the faculty class
 does not care where it passes a leaf(single student) or a composite (group of students - say group project for instance). The passed object's grade is modified.
* */
...
public class Modify_grade {
    ...
    private String reason; // The reason why the grade is being modified
    private Connection con;

    // Leaf constructor for a single student
    public Modify_grade(Student s, String coursecode,String Grade,String rea,Connection co) {
        student = s;
        grade = Grade;
    ...
    public Modify_grade(List<Student> studs, String coursecode, String Grade,String rea, Connection co){
        students = studs;
        grade = Grade;
        Coursecode = coursecode;
        reason = rea;
